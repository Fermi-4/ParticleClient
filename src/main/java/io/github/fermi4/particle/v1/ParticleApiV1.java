...
public class ParticleApiV1 {
    ...
    protected static HttpUrl getUpdateProductTeamMemberTokenHttpUrl(String token, String productIdOrSlug, String username) {
        Builder builder = new HttpUrl.Builder();
    ...
    protected static HttpUrl getUpdateProductTeamMemberHttpUrl(String token, String productIdOrSlug, String username) {
        Builder builder = new HttpUrl.Builder();
     ...
     * @return {@link HttpUrl}
     */
    protected static HttpUrl getProductEventsFiltered(String accessToken, String productIdOrSlug, String eventPrefix) {
        Builder builder = new HttpUrl.Builder();
    ...
    protected static HttpUrl getHistoricalDeviceVitalsHttpUrl(String accessToken, String deviceId, Instant start, Instant end) {
        Builder builder = new HttpUrl.Builder();
