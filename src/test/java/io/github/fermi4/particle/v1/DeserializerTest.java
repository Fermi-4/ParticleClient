...
public class DeserializerTest {
    ...
    public void testDeserializeDeviceInfo() throws JsonMappingException, JsonProcessingException {
        String test = "{\n" + //
                ...
                "}";
        assertDoesNotThrow(
                () -> ParticleDeserializer.getParticleDeserializer().readValue(test, DeviceInformation.class));
    }

    @Test
    public void testDeserializeDeviceInfoArray() throws JsonMappingException, JsonProcessingException {
        String test = "[{\n" + //
                "  \"id\": \"0123456789abcdef01234567\",\n" + //
                "  \"name\": \"gongbot\",\n" + //
                "  \"owner\": \"someone@particle.io\",\n" + //
